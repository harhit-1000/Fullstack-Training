...
app.use("/blogs",verifyToken,roleAuth(["user","admin"]),blogRouter);
app.use("/user",verifyToken,roleAuth(["user","admin"]),userRouter);
app.use("/categories",verifyToken, roleAuth(["admin"]), categoryRouter);
app.use("/comments", verifyToken, roleAuth(["user","admin"]),commentRouter);
app.get("/",(req,res)=>{
